<script setup>
import demoDraggable from './demoDraggable.vue'
import demoNaiveuiBase from './demoNaiveuiBase.vue'
import demoNaiveuiDialog from './demoNaiveuiDialog.vue'
</script>
...
<demoDraggable class="mt-2" />

<details>

<summary>查看代码</summary>

<<< @/hooks/useDraggable/demoDraggable.vue
...
<demoNaiveuiBase class="mt-2" />

<details>

<summary>查看代码</summary>

<<< @/hooks/useDraggable/demoNaiveuiBase.vue
...
<demoNaiveuiDialog class="mt-2" />

<details>

<summary>查看代码</summary>

<<< @/hooks/useDraggable/demoNaiveuiDialog.vue
...
import { ref } from "vue";
import { useDraggable } from "@anyuan/utils";
...
```ts
//  在此处配置参数
const { draggable, dragging, transform, init, open, close, reset } =
  useDraggable(targetRef, dragRef, args);
```
...
<style scoped>
.code-no-border > table > thead > tr > th:nth-child(2) {
  min-width: 60px;
}
.code-no-border > table > thead > tr > th:nth-child(1) {
   min-width: 120px;
}
</style>
