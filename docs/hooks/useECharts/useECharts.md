<script setup>
// 偏业务示例
import Edynamic from "./demo/business/dynamic.vue";
import Erequest from "./demo/business/request.vue";
import Eloading from "./demo/business/loading.vue";
import EcustomTheme from "./demo/business/customTheme.vue";

// 常用示例
import Eline from "./demo/simple/line.vue";
import Ebar from "./demo/simple/bar.vue";
import Epie from "./demo/simple/pie.vue";
import Escatter from "./demo/simple/scatter.vue";
import Ecandlestick from "./demo/simple/candlestick.vue";
import Eradar from "./demo/simple/radar.vue";
import Eboxplot from "./demo/simple/boxplot.vue";
import Eheatmap from "./demo/simple/heatmap.vue";
import Egraph from "./demo/simple/graph.vue";
import Etree from "./demo/simple/tree.vue";
import Esunburst from "./demo/simple/sunburst.vue";
import Esankey from "./demo/simple/sankey.vue";
import Efunnel from "./demo/simple/funnel.vue";
import Egauge from "./demo/simple/gauge.vue";
import EpictorialBar from "./demo/simple/pictorialBar.vue";
import EthemeRiver from "./demo/simple/themeRiver.vue";

// 高级示例
import Edemo1 from "./demo/advanced/demo1.vue";
import Edemo2 from "./demo/advanced/demo2.vue";
import Edemo3 from "./demo/advanced/demo3.vue";
import Edemo4 from "./demo/advanced/demo4.vue";
import Edemo5 from "./demo/advanced/demo5.vue";
import Edemo6 from "./demo/advanced/demo6.vue";
</script>
...
```ts
//  在此处配置参数
const {} = useECharts(elRef, config, options);
```
...
| `config`     | 否   | 拥有`11`个属性，具体看下面的 `config` 详情                                                               | `EchartsConfigOptions` |
| `options`    | 否   | 拥有`11`个属性，具体看下面的 `options` 详情                                                              | `EChartsInitOpts`      |
...
| **参数属性**    | **说明**                  | **类型**                                           | **默认值**          |
| --------------- | ------------------------- | -------------------------------------------------- | ------------------- |
| theme           | echart theme              | `ThemeType.Light/ThemeType.Dark/ThemeType.Default` | `ThemeType.Default` |
| autoTooltipLoop | tooltip 是否自动循环      | `boolean`                                          | `false`             |
| autoLoopDelay   | 循环的时间间隔            | `number`                                           | 1500                |
| autoChartSize   | watch chart size changes  | `boolean`                                          | `false`             |
...
| `setOption`           | 根据配置项渲染`ECharts`，功能同 [setOption](https://echarts.apache.org/zh/option.html)                                                                                             | ` (options: UtilsEChartsOption, ...params: OptionsParams[]) => void` |
...
`setOption`非常重要，渲染图表都靠它。下面我们来详细了解一下吧 😜
...
所有 [events](https://echarts.apache.org/zh/api.html#events) 都在 `setOption` 里配置
