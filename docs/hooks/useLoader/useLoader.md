<script setup>
import demoLoadCss from './demoLoadCss.vue'
import demoLoadScript from './demoLoadScript.vue'
</script>
...
<demoLoadCss class="mt-2" />

<details>

<summary>查看代码</summary>

<<< @/hooks/useLoader/demoLoadCss.vue

</details>

#### 动态加载Script标签

<demoLoadScript class="mt-2" />

<details>

<summary>查看代码</summary>

<<< @/hooks/useLoader/demoLoadScript.vue
...
```ts
//  在此处配置参数
const { loadCss, removeCss, loadScript, removeScript } = useLoader(destroy);
```
...
| **名称**       | **说明**                 | **类型**                                                                           |
| -------------- | ------------------------ | ---------------------------------------------------------------------------------- |
| `loadCss`      | 动态加载`CSS`样式表      | `(opts: LoaderSource/LoaderSource[]/string/string[])=> Promise<UseLoaderReturn[]>` |
| `removeCss`    | 动态卸载`CSS`样式表      | `(opts: LoaderSource/LoaderSource[]/string/string[])=> Promise<UseLoaderReturn[]>` |
| `loadScript`   | 动态加载`JavaScript`脚本 | `(opts: LoaderSource/LoaderSource[]/string/string[])=> Promise<UseLoaderReturn[]>` |
| `removeScript` | 动态卸载`JavaScript`脚本 | `(opts: LoaderSource/LoaderSource[]/string/string[])=> Promise<UseLoaderReturn[]>` |
