...
import { useWatermark, imageToGrayScale } from "@anyuan/utils";
...
<template>
  <naive-theme>
    <div
      ref="colRef"
      class="mt-4 mb-4 w-full h-[300px] border-solid border-1 border-[var(--vp-c-divider)] rounded-md overflow-hidden"
    />
    来个灰色版咯
    <div
      ref="grayRef"
